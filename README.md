...
| Method                    | Branch                                                                                                              |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Progressive Web App (PWA) | [pwa](https://github.com/Ahmed-sherifhe1/5-Ways-To-Turn-Your-Website-into-a-Mobile-App/tree/pwa-method)             |
| Capacitor                 | [capacitor](https://github.com/Ahmed-sherifhe1/5-Ways-To-Turn-Your-Website-into-a-Mobile-App/tree/capacitor-method) |
| Cordova                   | cordova                                                                                                             |
...
| الطريقة                   | البرانش                                                                                                             |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| PWA (Progressive Web App) | [pwa](https://github.com/Ahmed-sherifhe1/5-Ways-To-Turn-Your-Website-into-a-Mobile-App/tree/pwa-method)             |
| Capacitor                 | [capacitor](https://github.com/Ahmed-sherifhe1/5-Ways-To-Turn-Your-Website-into-a-Mobile-App/tree/capacitor-method) |
| Cordova                   | cordova                                                                                                             |
| React WebView             | react-webview                                                                                                       |
| Flutter WebView           | flutter-webview                                                                                                     |
